...
import { AddCategoryModal, AddTagModal, AddChannelModal } from './shared';
...
const Navbar = ({ onSearch, query, onDataChange }: NavbarProps) => {
  ...
  return (
    <>
      ...
      {/* Modals - rendered outside nav for proper positioning */}
      <AddCategoryModal
